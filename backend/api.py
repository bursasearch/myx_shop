...
def get_stock_data_yahoo(symbol, start_date, end_date=None):
    ...
    try:
        ...
        print(f"成功获取 {symbol}: {len(prices)} 个数据点")
        return prices
