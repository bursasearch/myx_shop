...
# 讀取模板檔案
with open('web/history/sgx_picks_20260226.json', 'r') as f:
    template = json.load(f)

# 需要生成的日期
dates = ['20260227', '20260225', '20260214']

for date_id in dates:
    print(f"生成 {date_id} 的數據...")
    ...
    for i, pick in enumerate(data['picks']):
        ...
        # 修改變動和變動百分比
        change_variation = random.uniform(0.8, 1.2)
        ...
        # 修改評分 (±5分)
        score_change = random.uniform(-5, 5)
